  ...
  return (
    ...
    >
      ...
      {!isOpen && (
        <motion.button
          type="button"
          aria-label="Pull out filmstrip"
          onClick={onToggleCanister}
          className="absolute left-[-2px] top-1/2 z-30 block cursor-pointer overflow-hidden border-0 p-0 shadow-[0_10px_24px_rgba(0,0,0,0.42)]"
          initial={false}
          animate={{
            width: 68,
            opacity: 1,
          ...
          style={{
            height: H,
            clipPath:
              'polygon(0% 0%, calc(100% - 32px) 0%, calc(100% - 28px) 4%, calc(100% - 24px) 12%, calc(100% - 20px) 25%, calc(100% - 16px) 38%, calc(100% - 10px) 43%, 100% 45%, 100% 100%, 0% 100%)',
            background:
              'linear-gradient(to bottom, #100602 0%, #301406 15%, #421c08 15%, #381604 85%, #200c03 85%, #100602 100%)',
          }}
          title="Click to pull out filmstrip"
        >
          <span className="pointer-events-none absolute inset-0 bg-gradient-to-b from-white/10 via-transparent to-black/15" />
          <span className="pointer-events-none absolute inset-x-0 top-1/4 h-px bg-white/10" />
          <span className="pointer-events-none absolute inset-y-0 right-0 w-[48px] bg-[linear-gradient(to_bottom,#110703_0%,#3a1604_15%,#461c08_85%,#110703_100%)]" />
          <span className="pointer-events-none absolute left-2 top-1.5 h-2.5 w-1.5 rounded-[1.5px] border border-black/40 bg-[#0A0A0B]" />
          <span className="pointer-events-none absolute bottom-1.5 left-2 h-2.5 w-1.5 rounded-[1.5px] border border-black/40 bg-[#0A0A0B]" />
          <span className="pointer-events-none absolute bottom-1.5 right-5 h-2.5 w-1.5 rounded-[1.5px] border border-black/40 bg-[#0A0A0B]" />
          <span className="pointer-events-none absolute right-3 top-[68%] -translate-y-1/2 text-[10px] font-bold leading-none text-[#FFB800]">
            ►
          </span>
        </motion.button>
      )}
