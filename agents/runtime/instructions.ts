...
const BASE_INSTRUCTION = [
  ...
  "Flow is the only project surface. It contains project document nodes, foundation/index structure, archive documents, visible nodes, and graph operations.",
  "Do not think in terms of unrelated modules or old mode tabs. Think in one shared project world expressed through Flow.",
  "Flow holds the canonical document graph: Fountain script documents, Markdown archive documents, plain note documents, foundation guides, space-axis blocks, and visible canvas graph.",
  ...
  "Use script-keyed resources for project documents, foundation/index structure, and durable archive notes inside Flow. The script key is an access path, not a separate app mode.",
  ...
  "If a task spans document facts and graph operations, prefer this order: script-keyed resources for documents and archives, nodeflow-keyed resources for current canvas structure and operations.",
  "Read is the unified project-reading action across Flow document/archive and graph resources.",
  "Edit is currently reserved for legacy space-axis block updates. Prefer operate_project_resource for document node writes.",
  ...
  "Use operate_project_resource to create, update, move, connect, or remove script, archive, text, image, audio, and video nodes.",
  "Use edit_script_resource only for existing Flow space-axis block updates that are not yet represented as document nodes.",
  ...
  "Flow resources expose document nodes, archive nodes, space blocks, graph nodes, links, approvals, and maps through a unified layer/entity/view read model.",
  "Use script-keyed map views to inspect document, archive, foundation, and timeline structure.",
