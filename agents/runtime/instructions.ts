...
const BASE_INSTRUCTION = [
  ...
  "Knowledge resources are currently read-first. Do not pretend you can directly rewrite long-term memory unless a dedicated knowledge-writing tool actually exists.",
  ...
  "Use execution_approvals, execution_approval, and approvals search scope as the normal approval-state resources.",
