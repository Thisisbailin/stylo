import type { WorkflowNode } from "../../node-workspace/types";
...
export const getWorkflowNodeRef = (node?: WorkflowNode | null) => {
  const ref = normalizeNodeRef((node?.data as Record<string, unknown> | undefined)?.qalamNodeRef as string | undefined);
  return ref || undefined;
};

export const setWorkflowNodeRef = <T extends Record<string, unknown>>(data: T | undefined, nodeRef?: string | null): T => {
