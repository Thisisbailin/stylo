...
export const AGENT_PROMPT_CATALOG: AgentPromptCatalogEntry[] = [
  ...
  },
  {
    ...
    "sourcePath": "agents/tools/operateProjectResource.ts",
    "sourceLine": 46,
    "content": "Flow graph node kind to create. Only supports basic nodes: script, archive, text, image, audio, video, pdf. Folder nodes are generated by foundation operations.",
    "kind": "tool-schema",
    "chars": 160
  },
  {
  ...
  {
    "id": "ace0d40f2f60",
    "title": "pdf_url · description",
    "category": "tool",
    "sourcePath": "agents/tools/operateProjectResource.ts",
    "sourceLine": 86,
    "content": "PDF URL for PDF input nodes.",
    "kind": "tool-schema",
    "chars": 28
  },
  {
  ...
  },
  {
    ...
    "sourcePath": "agents/tools/operateProjectResource.ts",
    "sourceLine": 94,
    "content": "Optional MIME type for audio, video, or PDF nodes.",
    "kind": "tool-schema",
    "chars": 50
  },
  {
