...
const operateProjectResourceParameters = {
  ...
  properties: {
    ...
    node_kind: {
      type: "string",
      description: "Flow graph node kind to create. Only supports basic nodes: script, archive, text, image, audio, video. Folder nodes are generated by foundation operations.",
    },
    node_id: {
      type: "string",
